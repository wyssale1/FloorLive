    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-white/40 backdrop-blur-sm rounded-lg border border-gray-100 hover:bg-white/60 transition-all duration-200 group"
            >
            ...
            <AnimatePresence>
                {isExpanded && (
                    ...
                    >
                        <div className="mt-2 bg-white/60 backdrop-blur-sm rounded-lg border border-gray-100">
                            {isLoading ? (
